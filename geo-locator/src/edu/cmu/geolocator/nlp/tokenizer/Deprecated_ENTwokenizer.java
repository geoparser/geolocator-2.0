...
public class Deprecated_ENTwokenizer  {
	    ...
	    public static String[] tokenize(String text) {
			String[] a={};
			return simpleTokenize(squeezeWhitespace(text)).toArray(a);
		}
	  ...
	  /*  public static List<String> tokenizeRawTweetText(String text) {
	    ...
	    */
	    public static void main(String[] args) throws IOException {
	 	   Deprecated_ENTwokenizer twokenizer = new Deprecated_ENTwokenizer();	     
	        BufferedReader br = new BufferedReader(new InputStreamReader(System.in,"utf-8"));
	        System.out.print("> ");
	        // Read user input
	        String inputStr = br.readLine();
	        while (!inputStr.equals("")) {
	        	//English tokenizer can not handle this mark.
	        	//inputStr="¡¡¡¡¡¡¡¡¡this is a firlst excl@sdjfkåsdjf åsdjfk";
	     	   String[] tokens = twokenizer.tokenize(inputStr);
